...
const EditPet = () => {
    ...
    useEffect(() => {
        axios
            .get('http://localhost:4000/api/pet/' + idPet)
            .then((res) => {
                setPet(res.data);
        ...
        axios
            .get('http://localhost:4000/api/refuge/' + idPet)
